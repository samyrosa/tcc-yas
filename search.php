...
<body>
  ...
  <div id="yas_pesquisa" class="container mt-5 yas_search">
    <form method="$_GET" action="search.php">
      <input class="form-control me-2 shadow" id="search" type="search" placeholder="Pesquisa..." aria-label="Search"
        name="pesquisa" value="<?php echo $pesquisa ?>">
      ...
      <div class="col-12 border-bottom border-2">
        <div class="row">
          ...
          <div class="col-6  text-end">
            <button onclick="window.location.href = 'search.php?pesquisa=<?php echo $pesquisa ?>&cond=projeto'"
              type='button' class='btn btn-primary btn-sm  me-2 px-3'>Projeto</button>
            <button onclick="window.location.href = 'search.php?pesquisa=<?php echo $pesquisa?>&cond=artista'"
              type='button' class='btn btn-primary btn-sm me-1 px-3'>Artistas</button>
          </div>
        </div>
      </div>
