...
<form action='user-login.php' method="post">
    <div class="container mt-5 pe-5" style="background-color:#e6e0de;">
        <div class="row">
            ...
            <div class="col-8 mt-4 ">
                ...
                <div class="col"> <label for="email">Email</label><input class="form-control shadow " type="email"
                        name="email" id="email" value="<?php echo $value->user_email_cont?>">
                </div>
                <div class="row">
                    <div class="col-6"> <label for="phone">Telefone</label><input class="form-control shadow" type="tel"
                            id="phone" name="phone" placeholder="(DD) 12345-6789" value="<?php echo $value->user_telefone_cont?>">
                    </div>
                    <div class="col-6">
                        <label for="phone">WhatsApp</label><input class="form-control shadow" type="tel" id="phone"
                            name="phone" placeholder="(DD) 12345-6789" value="<?php echo $value->user_whatsapp_cont?>">
                    </div>
                </div>
                <div class="container-fluid my-4 border-bottom border-dark border-1">
                    <h5>REDES SOCIAIS</h5>
                ...
                <div class="row">
                    <div class="col"><label for="sobrenome">Instagram</label><input class="form-control shadow "
                            type="text" name="sobrenome" id="sobrenome" size="30" maxlength="30" value="<?php echo $value->social_insta?>">
                        </div>
                    <div class="col"><label for="sobrenome">Twitter</label><input class="form-control shadow "
                            type="text" name="sobrenome" id="sobrenome" size="30" maxlength="30" value="<?php echo $value->social_twitter?>">
                        </div>
                </div>
                <div class="col mb-5">
                    <label for="sobrenome">Link</label><input class="form-control shadow " type="text" name="sobrenome"
                        id="sobrenome" size="30" maxlength="30" value="<?php echo $value->social_url?>">
                </div>
            </div>
        </div>
    </div>
