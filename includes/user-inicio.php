  ...
  <form method="$_GET" action="search.php">
    ...
    <div class="text-center mt-4">
      <button onclick="window.location.href = 'index.php'" type='button'
        class='btn btn-primary btn-sm me-4 px-4'>Todos</button>
      <button onclick="window.location.href = 'index.php?ordem=recente'" type='button'
        class='btn btn-primary btn-sm me-4 px-3'>Recentes</button>
      <button onclick="window.location.href = 'index.php?ordem=antigo'" type='button'
        class='btn btn-primary btn-sm me-4 px-3'>Antigos</button>
    </div>
  </form>
</div>
