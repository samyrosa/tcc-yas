                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary data-bs-dismiss="
                                modal"">&nbsp&nbspOK&nbsp&nbsp</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-8">
                <div class="col-12">
                    <div class="row pb-2 border-bottom border-2">
                        <div class="col-9">
                            <button onclick="window.location.href = 'user-perfil.php?cod=<?php echo $cod; ?>'"
                                type='button' class='btn btn-primary btn-sm me-2 px-2'><i class="bi bi-grid-fill"></i>
                                Galeria</button>
                            <button onclick="window.location.href = 'user-perfil.php?cod=<?php echo $cod; ?>&mod=mim'"
                                type='button' class='btn btn-primary btn-sm me-2 px-2'><i class="bi bi-card-text"></i>
                                Sobre Mim</button>
                            <?php
                            if (is_user()) {
                            ?>
                            <button
                                onclick="window.location.href = 'user-perfil.php?cod=<?php echo $cod; ?>&mod=salvos'"
                                type='button' class='btn btn-primary btn-sm me-2 px-2'><i
                                    class="bi bi-star-fill"></i></button>
                            <button onclick="window.location.href = 'user-perfil.php?cod=<?php echo $cod; ?>&mod=insp'"
                                type='button' class='btn btn-primary btn-sm me-2 px-2'><i
